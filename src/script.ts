import "./style.css";
import { browser, parseHTML, decodeSongs, encodeSongs, icon } from "./lib/functions";
...
let display: Window | null,
 ...
 config = {
  ...
  editor: `<title>OpenWebLP Editor</title><style>body{background-color:black;color:white;font-family:sans-serif;}</style><link rel="icon" href=${icon}>`,
 };
